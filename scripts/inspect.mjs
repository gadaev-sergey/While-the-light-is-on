...
console.log('INITIAL',await page.evaluate(()=>({rooms:window.__BASE__.snapshot().rooms.length,openings:window.__BASE__.snapshot().openings.length})));
...
await page.screenshot({path:'artifacts/base/upstairs.png'});console.log('UPSTAIRS',await page.evaluate(()=>window.__BASE__.snapshot().player.floor));
